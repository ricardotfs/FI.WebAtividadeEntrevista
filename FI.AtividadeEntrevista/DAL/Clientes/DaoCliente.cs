...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal bool IsExistCpf(string cpf)
        {
        ...
        private List<DML.Beneficiario> ConverterBeneficiario(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    var benef = new DML.Beneficiario();
        ...
        internal void AlterarBeneficiario(long IdCliente)
        {
            var parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("IdCliente", IdCliente));

            base.Executar("FI_SP_RemoveBenef", parametros);
        }

        internal void AddBeneficiario(Cliente cliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = null;
            ...
            foreach (var benef in cliente.Beneficiarios)
            {
                ...
                base.Executar("FI_SP_AddBenef", parametros);
            }
        }

        internal List<Beneficiario> BuscarBeneficiario(long idCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            List<Beneficiario> benef = ConverterBeneficiario(ds);
